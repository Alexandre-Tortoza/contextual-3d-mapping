...
- interpretar semântica em nível de cena e de região como claims auditáveis, não labels
  únicos;
- distinguir geometria visual de evidência contextual: publicar como observação contextual
  apenas a evidência que discrimina algo, mantendo superfície estrutural genérica como
  contexto interno, sem exigir que toda região receba identidade semântica de alto nível;

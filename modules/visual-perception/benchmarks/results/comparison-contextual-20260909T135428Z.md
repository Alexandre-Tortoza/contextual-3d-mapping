# Comparação: 20260908T131207Z → 20260909T135428Z

| | baseline | candidato |
| --- | --- | --- |
| revisão | `03ec593` | `1270e53` |
...
| eixo | 20260908T131207Z | 20260909T135428Z |
| --- | ---: | ---: |
...
| grupos de superfície | n/a | 7 |
| regiões em grupo | n/a | 30 |
| grupos corroborados | n/a | 6 |
...
| audit errors | 0 | 0 |
| audit warnings | 51 | 58 |
| latência (s) | 189 | 352 |
| chamadas de modelo (total) | 164 | 234 |

Relações semânticas: `covers` × 4, `part_of` × 3, `attached_to` × 1.
Custo dos estágios novos: hypothesis_support_text=30, region_refinement=24, semantic_relations=16.
Refinamento it0: 24 alvos, 24 reinterpretadas, evidência ['masked_subject', 'tight_crop', 'contextual_crop'] → ['masked_subject', 'tight_crop', 'contextual_crop', 'scene_conditioned'], razões={'unsupported_primary': 5, 'small_region': 4, 'region_kind_contradiction': 20, 'insufficient_foreground': 2, 'competing_hypotheses': 2}.
...
| falhas de relação | n/a | 0 |
| audit errors | 0 | 0 |
| audit warnings | 16 | 11 |
| latência (s) | 92 | 173 |
| chamadas de modelo (total) | 68 | 114 |

Relações semânticas: `covers` × 1, `part_of` × 1.
Custo dos estágios novos: hypothesis_support_text=27, region_refinement=8, semantic_relations=11.
Refinamento it0: 8 alvos, 8 reinterpretadas, evidência ['masked_subject', 'tight_crop', 'contextual_crop'] → ['masked_subject', 'tight_crop', 'contextual_crop', 'scene_conditioned'], razões={'unsupported_primary': 1, 'small_region': 5, 'region_kind_contradiction': 3, 'competing_hypotheses': 4}.
...
| falhas de relação | n/a | 0 |
| audit errors | 0 | 0 |
| audit warnings | 49 | 58 |
| latência (s) | 175 | 340 |
| chamadas de modelo (total) | 156 | 220 |

Relações semânticas: `part_of` × 6, `covers` × 1.
Custo dos estágios novos: hypothesis_support_text=24, region_refinement=24, semantic_relations=16.
Refinamento it0: 24 alvos, 24 reinterpretadas, evidência ['masked_subject', 'tight_crop', 'contextual_crop'] → ['masked_subject', 'tight_crop', 'contextual_crop', 'scene_conditioned'], razões={'unsupported_primary': 6, 'small_region': 6, 'region_kind_contradiction': 22, 'competing_hypotheses': 2, 'insufficient_foreground': 1}.

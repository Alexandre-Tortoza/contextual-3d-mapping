...
| Carion et al., **SAM 3: Segment Anything with Concepts** | [arXiv:2511.16719](https://arxiv.org/abs/2511.16719), [código](https://github.com/facebookresearch/sam3) | provider `sam3` de discovery por segment everything com o tracker de imagem (0.80/0.90); PCS por prompt genérico descartado por devolver zero masks; benchmark pendente (#220) |
